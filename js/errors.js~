...
jQuery(document).ready( function()
{
	...
	jQuery("#valid-email").click(function()
	{
	...
	jQuery("input[type=submit]").click(function()
	{
		...
		if(name_result==1 || name_result1==1 || result==1 || result1==1 || result2==1)
		{
			jQuery("#form_error").text("Please fill all the mandatory fields");
			return false;	
		}
		else
		{
